...
public class Profile2 extends AppCompatActivity {
    TextView profile_userName,profile_email,profile_phone,golden_zone,golden_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        golden_zone = (TextView)findViewById(R.id.golden_zone);
        golden_address = (TextView)findViewById(R.id.golden_address);
      ...
      //  profile_follow_btn = (Button)findViewById(R.id.profile_follow_btn);
        ...
        userRef.child(CurrentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                golden_address.setText(dataSnapshot.child("address").getValue().toString());
                golden_zone.setText(dataSnapshot.child("UserArea").getValue().toString());
